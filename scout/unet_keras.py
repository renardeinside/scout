...
def get_unet(path):
    ...
    up8 = tf.keras.layers.Conv2DTranspose(
        base_filters * 32, 2, strides=pool_size, **conv_args
    )(drop7)
    ...
    up9 = tf.keras.layers.Conv2DTranspose(
        base_filters * 16, 2, strides=pool_size, **conv_args
    )(conv8)
    ...
    up10 = tf.keras.layers.Conv2DTranspose(
        base_filters * 8, 2, strides=pool_size, **conv_args
    )(conv9)
    ...
    up11 = tf.keras.layers.Conv2DTranspose(
        base_filters * 4, 2, strides=pool_size, **conv_args
    )(conv10)
    ...
    up12 = tf.keras.layers.Conv2DTranspose(
        base_filters * 2, 2, strides=pool_size, **conv_args
    )(conv11)
    ...
    up13 = tf.keras.layers.Conv2DTranspose(
        base_filters, 2, strides=pool_size, **conv_args
    )(conv12)
